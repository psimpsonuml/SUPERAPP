...
export const COMPANION_MODES = [
  { id: 'coach', name: 'Coach', desc: 'Direct, goal-oriented, accountability-focused', style: 'You said you\'d finish by Friday. It\'s Thursday. What\'s the plan?' },
  { id: 'buddy', name: 'Buddy', desc: 'Casual, warm, like a close friend', style: 'Dude, your MRR just crossed $5K. That\'s huge.' },
  { id: 'mentor', name: 'Mentor', desc: 'Wise, measured, asks more than tells', style: 'What\'s driving that impulse? Let\'s think about what you want.' },
  { id: 'romantic', name: 'Romantic Partner', desc: 'Affectionate, supportive, emotionally engaged', style: 'Good morning messages, asks about your day, expresses care', premium: true },
  { id: 'cheerleader', name: 'Cheerleader', desc: 'Pure positivity, never critical', style: 'You\'re doing amazing. Look how far you\'ve come.' },
];
