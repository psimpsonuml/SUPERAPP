...
const REQUIRED_TABLES = [
  ...
  { table: 'wrestling_events', checkCol: 'promotion' },
  { table: 'wrestling_matches', checkCol: 'participants_json' },
  { table: 'wrestling_ratings', checkCol: 'score' },
  { table: 'wrestling_cascade_scores', checkCol: 'composite_score' },
  { table: 'wrestling_stats', checkCol: 'payload_json' },
  { table: 'growth_suppressions', checkCol: 'reason' },
  { table: 'dispatch_log', checkCol: 'handler' },
  { table: 'sending_mailboxes', checkCol: 'volume_date' },
  { table: 'growth_settings', checkCol: 'key' },
  { table: 'growth_campaigns', checkCol: 'slug' },
  { table: 'content_sources', checkCol: 'source_confidence' },
  { table: 'growth_content', checkCol: 'requires_manual_posting' },
  { table: 'growth_content_events', checkCol: 'event_type' },
  { table: 'growth_assets', checkCol: 'asset_type' },
  { table: 'growth_prospects', checkCol: 'payroll_fit_score' },
  { table: 'growth_prospect_events', checkCol: 'event_type' },
  { table: 'growth_outreach', checkCol: 'sequence' },
  { table: 'growth_cost_events', checkCol: 'estimated_cost' },
  { table: 'growth_attribution_events', checkCol: 'utm_campaign' },
